...
public class PlayerRepository {
    ...
    public Player addIndividualPlayer(Player player) {
    ...
    public void addPlayer(Player player, int team_id){
    ...
    public void updatePlayer(Player player,int team_id){
    ...
    public void getPlayer(int player_id,int team_id){
    ...
    public Player getPlayerDetails(int player_id){
    ...
    public Player getPlayerSummary(int player_id,int team_id){
    ...
    public Player getPlayerInMatch(int matchId,int playerId) {
        String sqlQuery = "select * from matches where id = "+matchId;
        Player player = null;
        try {
            PreparedStatement preparedStatement = conn.prepareStatement(sqlQuery);
