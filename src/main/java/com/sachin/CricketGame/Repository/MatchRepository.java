...
public class MatchRepository {
    ...
    public int addMatch(Cricket cricket) {
        int match_id = 0;
    ...
    public void updateMatch(Cricket cricket) {
        String sqlQuery = "update matches set innings_one = ?,innings_two = ?,winning_team_id = ?," +
                "comment = ?,status = ? where id = " + cricket.getMatch_id();
        try {
...
//        rs.close();
//    }
    public Cricket getGameSummary(int id) {
