...
public class BowlerRepository {
    ...
    public void addBowler(Bowler bowler, int id) throws SQLException {
    ...
    public void updateBowler(Bowler bowler,int team_id) throws SQLException {
    ...
    public Bowler getBowlerSummary(int id,int team_id) throws SQLException {
